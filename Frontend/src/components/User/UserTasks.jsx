...
const initialTasks = [
  { id: 1, title: "Fix Navbar Bug", status: "In Progress", due: "2025-09-20" },
  { id: 2, title: "Update Landing Page", status: "Done", due: "2025-09-15" },
  { id: 3, title: "Prepare Presentation", status: "Pending", due: "2025-09-25" },
  { id: 4, title: "Deploy Backend Service", status: "Done", due: "2025-09-10" },
  { id: 5, title: "Design New Icons", status: "In Progress", due: "2025-09-22" },
];
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          ...
          <div className="flex items-center space-x-2 mt-4 md:mt-0">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm rounded-full transition-all duration-200 shadow-sm ${sortKey === 'title' ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Title
            </button>
            <button
              onClick={() => handleSort('status')}
              className={`px-4 py-2 text-sm rounded-full transition-all duration-200 shadow-sm ${sortKey === 'status' ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Status
            </button>
            <button
              onClick={() => handleSort('due')}
              className={`px-4 py-2 text-sm rounded-full transition-all duration-200 shadow-sm ${sortKey === 'due' ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Due Date
            </button>
          </div>
